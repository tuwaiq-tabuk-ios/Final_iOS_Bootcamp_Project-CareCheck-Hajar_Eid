...
//            cell?.checkBox.buttonChecked(sender: cell!.checkBox)
//        } else{
...
//        medsTableView.deselectRow(at: indexPath,
//                                  animated: true)
//        let cell = medsTableView.cellForRow(at: indexPath as IndexPath) as! ReminderTableCell
//
//        if (rowsWhichAreChecked.contains(indexPath as NSIndexPath) == false) {
//            cell.checkBox.isChecked = true
//            cell.checkBox.buttonChecked(sender: cell.checkBox)
...
//    func tableView(_ tableView: UITableView,
//                   didDeselectRowAt indexPath: IndexPath) {
//        let cell = tableView.cellForRow(at: indexPath as IndexPath) as! ReminderTableCell
//        cell.checkBox.isChecked = false
//        cell.checkBox.buttonChecked(sender: cell.checkBox)
//
//        //remove indexPath from rowsWhichAreChecked
